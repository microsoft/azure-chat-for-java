  ...
  $.each(userBean.userMessageListBean.userMsgList,function(index,userMessageBean){
	$(".status-update-box").append('<div class="row" style="height:auto;">'+
	  ...
	  if(userMessageBean.mediaType=='image'){
		  ...
		  $("#div_vedContent_"+userMessageBean.msgID).append('<video class="videoContent" id="video_'+userMessageBean.msgID+'" width="640" height="360" controls preload="none" poster="'+pageContext.request.contextPath+'"/images/posterCover.jpg" onclick="startVideo(this);"><source src="'+userMessageBean.mediaUrl+'"/>" type="'+userMessageBean.mediaType+'"/>"></source></video>');
	  }
